...
const HumanoidSection = () => {
  ...
  return (
    <div
      ...
      style={{ height: '300vh' }}
    >
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white dark:bg-gray-900" id="why-humanoid">
          ...
          <div className="mb-2 md:mb-3">
            <div className="flex items-center gap-4 mb-2 md:mb-2 pt-8 sm:pt-6 md:pt-4">
              <div className="pulse-chip opacity-0 animate-fade-in" style={{
                ...
                <span>Seminar Overview</span>
              </div>
            </div>

            <h2 className="section-title text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-1 md:mb-2 dark:text-white">
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-white/90 text-lg">
                    AI tools streamline repetitive processes, allowing you to focus on what truly matters
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  ...
                  <p className="text-white/90 text-lg">
                    Leverage machine learning insights to make informed, data-driven choices
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Enhance creativity & <span className="text-[#FC4D0A]">user experience</span>
                  </h3>
                  <p className="text-white/90 text-lg">
                    AI-powered tools unlock new possibilities for creative expression and seamless interactions
                  </p>
                </div>
              </div>
            </div>
